...
export const FourStages: Story = {
    ...
    render: () => (
        <div style={{ display: 'grid', gap: 24 }}>
            ...
            <Switch active aria-label="Off active" />
            <Switch active aria-label="On active" defaultChecked />
...
const calibrationStyle = {
    padding: '44px 36px',
    backgroundImage:
        'linear-gradient(90deg, rgba(15,23,42,.18) 1px, transparent 1px), linear-gradient(0deg, rgba(15,23,42,.18) 1px, transparent 1px), linear-gradient(90deg, rgba(47,125,255,.22), rgba(18,185,129,.22))',
    backgroundPosition: '0 0, 0 0, 0 50%',
    backgroundSize: '18px 18px, 18px 18px, 100% 10px',
...
export const Calibration: Story = {
    ...
    render: args => (
        <div style={calibrationStyle}>
            <ControlledSwitchDemo key={`${args.defaultChecked}`} {...args} />
        </div>
    ),
};
