...
export function Slider({
    ...
    const filterVersion = [
        ...
        Math.round(activeGlassBlur * 100),
        Math.round(activeGlassScaleX * 100),
        Math.round(activeGlassScaleY * 100),
    ].join('-');
    ...
    const filterBleed = Math.ceil(
        Math.max(activeGlassScaleX, activeGlassScaleY) * (1 + 0.2 * glassChroma) + activeGlassBlur + 4,
    );
    ...
    return (
        ...
        >
            ...
            >
                {isGlassActive && !useCanvasLens && controlSize.width > 0 && controlSize.height > 0 && (
                    <GlassFilter
                        ...
                        {isGlassActive ? (
                            <>
                                {useCanvasLens ? (
                                    ...
                                    <span
                                        className="gds-slider__lens-content"
                                        style={
                                            {
                                                '--gds-slider-lens-filter': `url(#${filterId})`,
                                                height: filterHeight,
                                    ...
                                    >
                                        <span
                                            className="gds-slider__lens-source"
                                            style={{
