...
const SYNTAX_MAP: Record<CodeBlockTheme, Record<CodeBlockMode, { color: SyntaxColors; mono: SyntaxColors }>> = {
    default: {
...
export function getSyntaxColors(theme: CodeBlockTheme, mode: CodeBlockMode, mono: boolean): SyntaxColors {
...
export function getShellColors(theme: CodeBlockTheme, mode: CodeBlockMode, syntax: SyntaxColors): ShellColors {
...
export function resolveTokenColor(cssVar: string | undefined, syntax: SyntaxColors): string {
