...
import { createContext, forwardRef, type ReactNode, useCallback, useContext, useId, useMemo, useState } from 'react';
 ...
 */
const SegmentedControlContext = createContext<{ layoutId: string } | null>(null);
