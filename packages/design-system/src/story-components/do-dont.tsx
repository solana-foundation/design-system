    ...
    return (
        <div className="flex flex-col gap-4">
            <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-green-700 text-xs uppercase tracking-wide">Do</span>
            </div>
    ...
    return (
        <div className="flex flex-col gap-4">
            <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-red-700 text-xs uppercase tracking-wide">Don't</span>
            </div>
            <div className="flex min-h-[80px] items-center justify-center rounded-lg border border-border-medium p-6">
                {children}
            </div>
