        ...
        <div className="max-w-4xl p-8">
            <div className="mb-8">
                ...
                <p className="text-body-lg text-text-medium">
                    Inter Variable with fluid responsive scaling. Display and title sizes scale between 768px and 1440px
                    viewport widths.
                </p>
            </div>
            ...
            <div className="space-y-8">
                <section>
                    <h2 className="mb-4 text-headline-lg text-text-high uppercase tracking-wider">Display & Titles</h2>
                ...
                <section>
                    <h2 className="mb-4 text-headline-lg text-text-high uppercase tracking-wider">Headlines</h2>
                    <div className="rounded-lg border border-border-medium p-6">
                        {headlines.map(style => (
                            <StyleRow
                                className={style.class}
                ...
                <section>
                    <h2 className="mb-4 text-headline-lg text-text-high uppercase tracking-wider">Body Text</h2>
                    <div className="rounded-lg border border-border-medium p-6">
                        {bodyText.map(style => (
                            <StyleRow
                                className={style.class}
                ...
                <section>
                    <h2 className="mb-4 text-headline-lg text-text-high uppercase tracking-wider">Button Text</h2>
                    <div className="rounded-lg border border-border-medium p-6">
...
function DisplayTitles() {
    return (
        <div className="max-w-4xl p-8">
            <div className="mb-6">
                <h2 className="mb-2 text-text-extra-high text-title-lg">Display & Titles</h2>
                <p className="text-body-md text-text-medium">
                    Fluid typography that scales between 768px and 1440px viewport widths. Uses Inter Variable at weight
                    500.
                </p>
            </div>
            <div className="rounded-lg border border-border-medium p-6">
...
function FluidDemo() {
    return (
        <div className="max-w-4xl p-8">
            <div className="mb-6">
                <h2 className="mb-2 text-text-extra-high text-title-lg">Fluid Scaling Demo</h2>
            ...
            <div className="space-y-6 rounded-lg border border-border-medium p-8">
                <div>
                    <p className="mb-1 text-body-sm text-text-low">.text-display (36px → 48px)</p>
                    <p className="text-display text-text-extra-high">Display heading</p>
                </div>
                <div>
                    <p className="mb-1 text-body-sm text-text-low">.text-title-xl (28px → 36px)</p>
                    <p className="text-text-extra-high text-title-xl">Title extra large</p>
                </div>
                <div>
                    <p className="mb-1 text-body-sm text-text-low">.text-title-lg (22px → 28px)</p>
                    <p className="text-text-extra-high text-title-lg">Title large</p>
                </div>
                <div>
                    <p className="mb-1 text-body-sm text-text-low">.text-title-md (19px → 24px)</p>
                    <p className="text-text-extra-high text-title-md">Title medium</p>
                </div>
                <div>
                    <p className="mb-1 text-body-sm text-text-low">.text-title-sm (16px → 19px)</p>
...
function WeightScale() {
    ...
    return (
        <div className="max-w-3xl p-8">
            <div className="mb-6">
                <h2 className="mb-2 text-text-extra-high text-title-lg">Weight Scale</h2>
                <p className="text-body-md text-text-medium">
            ...
            <div className="space-y-3 rounded-lg border border-border-medium p-6">
                {weights.map(w => (
                    <div className="flex items-center gap-4" key={w.value}>
                        <span className="w-64 font-sans text-2xl text-text-extra-high" style={{ fontWeight: w.value }}>
                            The quick brown fox
                        </span>
                        <code className="font-mono text-text-medium text-xs">{w.value}</code>
                        <span
