...
function GrayScale() {
    return (
        <div className="min-w-[500px] p-8">
            <h2 className="mb-6 font-semibold text-text-extra-high text-xl">Gray Scale</h2>
            <div className="grid grid-cols-1 gap-2">
                {graySteps.map(step => (
                    <div className="flex items-center gap-4" key={step}>
                        ...
                        />
                        <code className="w-24 font-mono text-sm text-text-high">gray-{step}</code>
                    </div>
                ))}
            </div>
        </div>
...
function TextEmphasis() {
    return (
        <div className="min-w-[550px] p-8">
            <h2 className="mb-2 font-semibold text-text-extra-high text-xl">Text Emphasis</h2>
            ...
            <div className="grid grid-cols-1 gap-4">
                {textTokens.map(token => (
                    <div className="flex items-center gap-4" key={token.name}>
                        ...
                        <div>
                            <code className="font-mono text-sm text-text-high">{token.name}</code>
                            <span className="ml-2 text-sm text-text-medium">({token.opacity})</span>
...
function BorderScale() {
    return (
        <div className="min-w-[550px] p-8">
            <h2 className="mb-2 font-semibold text-text-extra-high text-xl">Border Scale</h2>
            <p className="mb-6 text-sm text-text-medium">
...
function BaseColors() {
    return (
        <div className="min-w-[400px] p-8">
            <h2 className="mb-6 font-semibold text-text-extra-high text-xl">Base Colors</h2>
            <div className="grid grid-cols-1 gap-4">
...
function StatusColors() {
    return (
        <div className="min-w-[550px] p-8">
            <h2 className="mb-2 font-semibold text-text-extra-high text-xl">Status Colors</h2>
            <p className="mb-6 text-sm text-text-medium">bg + border + text tokens for badges and alerts</p>
            <div className="grid grid-cols-1 gap-4">
                {statusTokens.map(status => (
                    <div className="flex items-center gap-4" key={status.name}>
                        ...
                        <div className="flex gap-3">
                            <code className="font-mono text-text-medium text-xs">status-{status.name}-bg</code>
                            <code className="font-mono text-text-medium text-xs">status-{status.name}-border</code>
                            <code className="font-mono text-text-medium text-xs">status-{status.name}-text</code>
                        </div>
                    </div>
                ))}
            </div>
