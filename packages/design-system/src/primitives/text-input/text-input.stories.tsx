import { EnvelopeIcon, EyeIcon, MagnifyingGlassIcon } from '@heroicons/react/24/outline';
                ...
                trailingAction={
                    showCopyButton ? (
                        <CopyButton
                            ...
                            label="Copy"
                            size={size}
                            value={typeof args.placeholder === 'string' ? args.placeholder : ''}
                            variant="addon"
                        />
                    ) : undefined
                }
    ...
    render: () => (
        <div className="flex w-[720px] flex-col gap-10 p-8">
            ...
            <section className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-6 rounded-xl border border-border-medium p-6">
                    ...
                    <TextInput
                        ...
                        type="password"
                    />
                    <TextInput label="Username" placeholder="Choose a username" size="md" />
                </div>
            </section>
            ...
            <section className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-4 rounded-xl border border-border-medium p-6">
                    <div className="flex flex-col gap-1">
                        <TextInput iconLeft={<MagnifyingGlassIcon />} placeholder="Search..." />
                        <span className="text-text-low text-xs">Icon left</span>
                    </div>
                    <div className="flex flex-col gap-1">
                        <TextInput iconRight={<EyeIcon />} placeholder="Password" type="password" />
            ...
            <section className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-4 rounded-xl border border-border-medium p-6">
                    <div className="flex flex-col gap-1">
                        <TextInput
                            action={<CopyButton size="md" value="sk_live_abc123def456ghi789jkl012mno345" />}
                            defaultValue="sk_live_abc123def456ghi789jkl012mno345"
                            inputClassName="font-mono"
                            label="API Key"
                            readOnly
                        />
                        <span className="text-text-low text-xs">Readonly + monospace + CopyButton action</span>
                    </div>
                    <div className="flex flex-col gap-1">
                        <TextInput
                            ...
                            type="password"
                        />
                        <span className="text-text-low text-xs">Password field with CopyButton action</span>
                    </div>
                    <div className="flex flex-col gap-1">
                        <TextInput
                        ...
                        />
                        <span className="text-text-low text-xs">Trailing action with inline CopyButton</span>
                    </div>
                </div>
            </section>
        </div>
...
export const LeadingText: Story = {
    ...
    render: () => (
        <div className="flex w-[720px] flex-col gap-10 p-8">
            <section className="flex flex-col gap-4">
                <h4 className="font-medium text-text-low text-xs">Leading Text Addon</h4>
                <div className="flex flex-col gap-6 rounded-xl border border-border-medium p-6">
                    <TextInput
                        label="Website"
...
export const LeadingDropdown: Story = {
    ...
    render: () => (
        <div className="flex w-[720px] flex-col gap-10 p-8">
            <section className="flex flex-col gap-4">
                <h4 className="font-medium text-text-low text-xs">Leading Dropdown Addon</h4>
                <div className="flex flex-col gap-6 rounded-xl border border-border-medium p-6">
                    <TextInput
...
export const TrailingDropdown: Story = {
    ...
    render: () => (
        <div className="flex w-[720px] flex-col gap-10 p-8">
            <section className="flex flex-col gap-4">
                <h4 className="font-medium text-text-low text-xs">Trailing Dropdown Addon</h4>
                <div className="flex flex-col gap-6 rounded-xl border border-border-medium p-6">
                    <TextInput
                        inputMode="decimal"
                        label="Amount"
