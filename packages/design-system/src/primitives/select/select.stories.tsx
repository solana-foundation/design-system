...
import { Select, SelectGroup, SelectGroupLabel, SelectItem, SelectSeparator } from './index';
...
export const Overview: Story = {
    ...
    render: () => (
        <div className="flex w-[720px] flex-col gap-10 p-8">
            ...
            {/* With Labels */}
            <section className="flex flex-col gap-4">
                <h4 className="font-medium text-text-low text-xs">Labels & Descriptions</h4>
            ...
            <section className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-6 rounded-xl border border-border-medium p-6">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <span className="text-text-low text-xs">Disabled — 40% opacity</span>
                    </div>
                </div>
            </section>
            ...
            <section className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-4 rounded-xl border border-border-medium p-6">
                    <div className="flex flex-col gap-1">
                        <Select defaultValue="mainnet" label="Network" placeholder="Select network">
                            <SelectItem icon={<GlobeAltIcon />} value="mainnet">
                                Mainnet Beta
                            </SelectItem>
                            <SelectItem icon={<CodeBracketIcon />} value="devnet">
                        ...
                        <span className="text-text-low text-xs">Icon in trigger syncs with selected item</span>
                    </div>
                </div>
            </section>
            ...
            <section className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-6 rounded-xl border border-border-medium p-6">
                    <Select description="Choose the network for deployment" label="Network" placeholder="Select...">
                        <SelectItem value="mainnet">Mainnet</SelectItem>
                        <SelectItem value="devnet">Devnet</SelectItem>
                    </Select>
                    <Select error="Please select a network" label="Network" placeholder="Select...">
                        <SelectItem value="mainnet">Mainnet</SelectItem>
                        <SelectItem value="devnet">Devnet</SelectItem>
                    </Select>
                </div>
            ...
            {/* Groups & Separators */}
            <section className="flex flex-col gap-4">
                <h4 className="font-medium text-text-low text-xs">Groups & Separators</h4>
                <div className="flex flex-col gap-4 rounded-xl border border-border-medium p-6">
            ...
            <section className="flex flex-col gap-4">
                <h4 className="font-medium text-text-low text-xs">Item Descriptions & Disabled</h4>
                <div className="flex flex-col gap-4 rounded-xl border border-border-medium p-6">
                    <Select label="Environment" placeholder="Select environment" size="lg">
                        <SelectItem description="Production environment" icon={<GlobeAltIcon />} value="mainnet">
                            Mainnet
                        </SelectItem>
                        <SelectItem description="For development and testing" icon={<CodeBracketIcon />} value="devnet">
                            Devnet
                        </SelectItem>
                        <SelectItem description="Currently unavailable" disabled icon={<BeakerIcon />} value="testnet">
                            Testnet
                        </SelectItem>
                    </Select>
                </div>
