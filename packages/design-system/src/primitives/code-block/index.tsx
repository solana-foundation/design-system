...
function handleLineClick(e: React.MouseEvent | React.KeyboardEvent, onLineClick?: (line: number) => void) {
        ...
        <>
            ...
            <div
                ...
                {...(hasInteractiveLines && {
                    ...
                    onKeyDown: (e: React.KeyboardEvent) => handleLineClick(e, onLineClick),
                })}
                style={{
                    tabSize: 2,
