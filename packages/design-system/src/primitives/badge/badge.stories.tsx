...
const meta: Meta<typeof Badge> = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: 'Compact status indicator with five color variants and an optional dot.',
            },
        },
    },
    argTypes: {
...
export const ColorSystem: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'All four chromatic variants use a systematic OKLCH formula: one hue per variant, consistent lightness and chroma per role (bg/text/dot), varying only by mode. Light text L=0.40 on bg L=0.955 yields ~7:1 contrast (WCAG AAA).',
            },
        },
    },
    render: () => (
        <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
                <span className="text-body-sm text-text-medium">Neutral variant — transparency-based, no OKLCH</span>
                <div className="flex flex-wrap items-center gap-3">
                    <Badge dot variant="default">
                        Default
                    </Badge>
...
export const OnDarkBackground: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'Dark mode inverts the OKLCH formula: bg L=0.22 (was 0.955), text L=0.82 (was 0.40), dot L=0.60 (was 0.55). Chroma stays consistent.',
            },
        },
    },
    render: () => (
...
export const InlineWithText: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: "Badges align vertically with body text. The 0.5px translateY on the text span compensates for Inter's ascender-heavy visual center at 12px.",
            },
        },
    },
    render: () => (
        <div className="flex flex-col gap-4">
            ...
            <p className="flex items-center gap-2 text-body-md text-text-high">
                Network <Badge variant="warning">Mainnet</Badge> requires additional permissions
            </p>
