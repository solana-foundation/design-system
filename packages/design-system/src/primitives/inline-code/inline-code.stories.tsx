...
export const Default: Story = {
  render: () => (
    <p className="text-body-md text-text-high">
      Use <InlineCode>clusterApiUrl("mainnet-beta")</InlineCode> to connect to
      the Solana mainnet cluster.
    </p>
  ),
};
...
export const MultipleInline: Story = {
  ...
  render: () => (
    <p className="text-body-md text-text-high">
      Import <InlineCode>Connection</InlineCode> and{" "}
      <InlineCode>PublicKey</InlineCode> from{" "}
      <InlineCode>@solana/web3.js</InlineCode> to interact with the Solana
      blockchain.
    </p>
  ),
};
