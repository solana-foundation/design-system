        ...
        <main className="flex min-h-screen flex-col items-center justify-between px-6 py-24 md:py-32">
            <div className="flex w-full max-w-xl flex-col gap-12">
                <header className="flex flex-col gap-3">
                    <div className="enter-animate text-body-sm-bold text-text-low" style={{ animationDelay: '0ms' }}>
                        Alpha
                    </div>
                    <h1 className="enter-animate text-display text-text-extra-high" style={{ animationDelay: '60ms' }}>
                        Solana Design System
                    </h1>
                    <p className="enter-animate text-body-lg text-text-medium" style={{ animationDelay: '120ms' }}>
                ...
                <section className="enter-animate flex flex-col gap-5" style={{ animationDelay: '220ms' }}>
                    ...
                    <CodeBlock code={`@import "@solana/design-system/defaults";`} label="Import styles" />
                    <CodeBlock code={`import { Button } from "@solana/design-system";`} label="Use" />
                </section>
            </div>
