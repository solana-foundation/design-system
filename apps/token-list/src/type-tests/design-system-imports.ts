// This file is typechecked by `tsc --noEmit` in CI.
// It should never be imported at runtime.

import type { TextInputProps } from '@solana/design-system/text-input';
...
const _assertTextInputProps = {} as TextInputProps;
void _assertTextInputProps;
